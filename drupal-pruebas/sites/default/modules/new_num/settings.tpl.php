  ...
  array (
    ...
    array (
      ...
      'prefix' => array (
		...
		'node' => '##NUMBER##_',
		'node_comment_statistics' => '##NUMBER##_',
		'node_revision' => '##NUMBER##_',
		'field_collection_item' => '##NUMBER##_',
		'search_index' => '##NUMBER##_',
		'search_dataset' => '##NUMBER##_',
		'search_node_links' => '##NUMBER##_',
		'search_total' => '##NUMBER##_',
		'field_data_body' => '##NUMBER##_',
		'field_revision_body'  => '##NUMBER##_',
		'cache_field'  => '##NUMBER##_',
		'cache' => '##NUMBER##_',
		'cache_menu' => '##NUMBER##_',
		'field_revision_field_texto_imprimible' => '##NUMBER##_',
		'field_data_field_texto_imprimible' => '##NUMBER##_'
      ),
    ),
  ),
);
